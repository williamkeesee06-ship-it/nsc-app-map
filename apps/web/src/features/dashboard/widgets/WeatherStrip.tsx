...
// Icon glyph for every 7 Ziply bucket. Partial<> lets legacy bucket keys
// (needs_fielding / pending / completed) fall back to no icon rather than
// force a definition that the dashboard no longer shows.
