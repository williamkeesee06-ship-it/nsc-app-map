    ...
    >
      ...
      >
        ...
        >
          ...
          <p style={{ margin: "4px 0 0 20px", fontSize: 9, color: "#475569" }}>
            Toggle the plant design overlay (hubs, terminals, cables) on the map.
          </p>
      </div>
                  ...
                  >
                    {siteJobs.map((job) => {
                      return (
                        ...
                        >
                          <span style={{ fontSize: 10, color: "#cbd5e1", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }} title={job.workOrder}>
                            {job.workOrder}{job.hubNumber ? ` · H${job.hubNumber}` : ""}
                          </span>
                          <span style={{ color: job.jobStatus === "Complete" ? "#1d4ed8" : "#4facfe", fontSize: 9 }}>
